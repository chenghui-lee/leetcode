/* 
Decrease to 1D by sorting the width in ACS, if got tie, sort height in DESC
This is to prevent [3,3] to fit inside [3,4]
The rest is just longest increasing subsequence (LIS)
*/
